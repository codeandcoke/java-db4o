...
import static org.sfaci.db4o_cliente.util.Constantes.CENTRO_COMERCIAL;
import static org.sfaci.db4o_cliente.util.Constantes.TIENDA;
...
import org.sfaci.db4o_cliente.util.Util.Accion;
 ...
 * conectando con un servidor a través de la red
 * 
...
public class HolaDb4o {
	...
	private void conectar() {
		...
		/*
		 *  Podemos abrir varias conexiones simultáneas con la Base de datos
		 *  
		 ...
		 *  Esta solución está pensada para aplicaciones servidor que soportan múltiples conexiones de clientes y quieren
 	 	 *  atender dichas peticiones de forma concurrente
		 */
		
		/*
		 *  Conecta con un servidor db4o a través de la red
		 *  Esta solución está pensada para múltiples clientes que se ejecutan en diferentes procesos
		 *  y quieren acceder a la base de datos de forma concurrente.
		 *  En este caso la Base de Datos se ejecuta como una instancia de servidor desde otra aplicación
		 *  a la que se llamaré 'servidor de db4o'
		 */
	...
	/**
	 * Cambia de pestaña. Hay que recargar el combo de campos
	 */
